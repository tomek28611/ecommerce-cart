...
import com.dailysales.backend.exeptions.ProductNotFoundExeption;
...
import com.dailysales.backend.repository.ProductRepository;
...
public class ProductService implements IProductService {
    ...
    @Override
    public Product updateProduct(ProductUpdateRequest request, Long prductId) {
    return productRepository.findById(prductId)
